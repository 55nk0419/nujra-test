...
- Updated CSS/JS cache-busting query strings to `?v=39`.
...
- Bumped cache query strings to `?v=39`.
...
- Updated cache-busting query strings to ?v=39.
...
- Updated CSS/JS cache query strings to `?v=39`.
