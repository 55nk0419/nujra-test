...
- Updated CSS/JS cache-busting query strings to `?v=32`.
...
- Bumped cache query strings to `?v=32`.
...
Upload the entire `v32/` folder to the repository root.

Test URL:
https://55nk0419.github.io/nujra-test/v32/
...
- Updated cache-busting query strings to ?v=32.
...
- Updated CSS/JS cache query strings to `?v=32`.
