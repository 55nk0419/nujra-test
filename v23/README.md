...
- `https://forms.gle/7KdCVpDDK1sPZobDA`
...
- Updated CSS/JS cache-busting query strings to `?v=23`.

## v23 folder deployment

Upload the entire `v23/` folder to the repository root.

Test URL:
https://55nk0419.github.io/nujra-test/v23/

Update:
- Connected the 入会フォーム links to `https://forms.gle/7KdCVpDDK1sPZobDA`.
- Updated CSS/JS cache-busting query strings to `?v=23`.
