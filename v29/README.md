...
- Updated CSS/JS cache-busting query strings to `?v=29`.
...
- Bumped cache query strings to `?v=29`.
...
Upload the entire `v29/` folder to the repository root.

Test URL:
https://55nk0419.github.io/nujra-test/v29/
