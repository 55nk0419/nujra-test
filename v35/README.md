...
- Updated CSS/JS cache-busting query strings to `?v=35`.
...
- Bumped cache query strings to `?v=35`.
...
Upload the entire `v35/` folder to the repository root.

Test URL:
https://55nk0419.github.io/nujra-test/v35/
...
- Updated cache-busting query strings to ?v=35.
...
- Updated CSS/JS cache query strings to `?v=35`.
