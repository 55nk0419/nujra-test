...
- Updated CSS/JS cache-busting query strings to `?v=34`.
...
- Bumped cache query strings to `?v=34`.
...
Upload the entire `v34/` folder to the repository root.

Test URL:
https://55nk0419.github.io/nujra-test/v34/
...
- Updated cache-busting query strings to ?v=34.
...
- Updated CSS/JS cache query strings to `?v=34`.
