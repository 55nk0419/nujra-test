...
- Updated CSS/JS cache-busting query strings to `?v=24`.

## v24 folder deployment

Upload the entire `v24/` folder to the repository root.

Test URL:
https://55nk0419.github.io/nujra-test/v24/
