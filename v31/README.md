...
- Updated CSS/JS cache-busting query strings to `?v=31`.
...
- Bumped cache query strings to `?v=31`.
...
Upload the entire `v31/` folder to the repository root.

Test URL:
https://55nk0419.github.io/nujra-test/v31/
...
- Updated cache-busting query strings to ?v=31.
